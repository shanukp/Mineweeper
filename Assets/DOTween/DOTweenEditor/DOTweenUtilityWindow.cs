...
namespace DG.DOTweenEditor
{
    ...
    class DOTweenUtilityWindow : EditorWindow
    {
        ...
        void OnEnable()
        {
            ...
            if (_headerImg == null) {
                _headerImg = AssetDatabase.LoadAssetAtPath("Assets/DOTween/DOTweenEditor/Imgs/Header.jpg", typeof(Texture2D)) as Texture2D;
                ...
                _footerImg = AssetDatabase.LoadAssetAtPath("Assets/DOTween/DOTweenEditor/" + (EditorGUIUtility.isProSkin ? "Imgs/Footer.png" : "Imgs/Footer_dark.png"), typeof(Texture2D)) as Texture2D;
